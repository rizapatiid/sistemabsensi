...
import { updateAvatarAdminAction } from "@/actions/admin"
import styles from "@/styles/profil_karyawan.module.css"

export default function AvatarEditorAdmin({ user }: { user: { fotoProfil: string | null; nama: string } }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        const res = await updateAvatarAdminAction(base64data)
