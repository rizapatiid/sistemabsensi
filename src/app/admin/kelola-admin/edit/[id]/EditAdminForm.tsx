...
const IconShieldAlert = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
)
              ...
              {success && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: '#f0fdf4', border: '1px solid #dcfce7', color: '#16a34a', padding: '16px', borderRadius: '14px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(22, 163, 74, 0.05)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <span style={{ fontSize: '0.75rem', fontWeight: 600, marginTop: '2px', opacity: 0.9 }}>Data administrator telah diperbarui. Mengalihkan...</span>
                  </div>
                </div>
              )}
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 240px), 1fr))', gap: '16px' }}>
                          <div className={styles.formGroup}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'center', background: '#f8fafc', borderRadius: '10px', border: '1px solid #e2e8f0', padding: '10px 16px', gap: '12px', boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.02)' }}>
                                  ...
                                  <input style={{ flex: 1, background: 'transparent', border: 'none', fontWeight: 900, fontSize: '0.85rem', color: '#10b981', outline: 'none' }} type="text" name="id" defaultValue={user.id} required />
                              </div>
                          </div>
                          <div className={styles.formGroup}>
                              <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 800, color: '#475569', marginBottom: '6px' }}>PERBARUI PASSWORD LOGIN</label>
                              <div style={{ display: 'flex', alignItems: 'center', background: '#f8fafc', borderRadius: '10px', border: '1px solid #e2e8f0', padding: '10px 16px', gap: '12px', boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.02)' }}>
                                  <div style={{ color: '#64748b', display: 'flex', alignItems: 'center' }}><IconLock /></div>
                                  <input style={{ flex: 1, background: 'transparent', border: 'none', fontWeight: 700, fontSize: '0.85rem', color: '#0f172a', outline: 'none' }} type="text" name="password" defaultValue={user.password} placeholder="Kosongkan jika tidak diubah" required />
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <div className={styles.formGroup}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', background: '#f8fafc', borderRadius: '10px', border: '1px solid #e2e8f0', padding: '10px 16px', gap: '12px', boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.02)' }}>
                              ...
                              <input style={{ flex: 1, background: 'transparent', border: 'none', fontWeight: 700, fontSize: '0.85rem', color: '#0f172a', outline: 'none' }} type="text" name="nama" defaultValue={user.nama} placeholder="Masukkan Nama Lengkap" required />
                          </div>
                      </div>
                  </div>
