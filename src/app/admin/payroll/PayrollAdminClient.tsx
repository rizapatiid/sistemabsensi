          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', width: '100%', maxWidth: '500px' }}>
              <div className={styles.statPill} style={{ flex: 1, borderColor: '#dcfce7', minWidth: '220px' }}>
                  ...
                  <div>
                      ...
                      <div style={{ fontSize: '0.65rem', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', marginTop: '4px' }}>Sudah Dibayar</div>
                  </div>
              </div>
              ...
              <div className={styles.statPill} style={{ flex: 1, borderColor: '#fff7ed', minWidth: '220px' }}>
                  ...
                  <div>
                      ...
                      <div style={{ fontSize: '0.65rem', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', marginTop: '4px' }}>Sedang Diproses</div>
                  </div>
              </div>
          </div>
        </div>
                    ...
                    <td style={{ textAlign: 'right' }}>
                      <form action={togglePayrollStatusAction.bind(null, p.id, p.statusPembayaran)}>
                        <button type="submit" className={styles.btnSm} style={{ 
                          background: p.statusPembayaran === 'DIBAYAR' ? '#f1f5f9' : '#1e3a8a',
                          color: p.statusPembayaran === 'DIBAYAR' ? '#64748b' : 'white',
                          border: 'none',
                          padding: '10px 16px',
                          borderRadius: '12px',
                          fontWeight: 850
                        }}>
                          {p.statusPembayaran === "DIBAYAR" ? "SET DIPROSES" : "SET DIBAYAR"}
                        </button>
                      </form>
                    </td>
                  </tr>
