...
import { createAnnouncementAction, generateAiImageAction } from "@/actions/admin"
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '12px 16px', gap: '12px', boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.01) inset', transition: 'all 0.2s' }}>
                                ...
                                <input style={{ flex: 1, background: 'transparent', border: 'none', fontWeight: 700, fontSize: '0.9rem', color: '#0f172a', outline: 'none' }} type="text" name="judul" placeholder="Masukkan Judul Pengumuman..." required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '20px' }}>
                            <div className={styles.formGroup}>
                                <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 800, color: '#475569', marginBottom: '8px', letterSpacing: '0.02em' }}>BANNER GAMBAR (OPSIONAL)</label>
                                ...
                                {!imagePreview ? (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                        <label style={{ 
                                            ...
                                            <span style={{ fontSize: '0.9rem', fontWeight: 800, color: '#0f172a' }}>Klik untuk mengunggah gambar</span>
                            ...
                            <div className={styles.formGroup}>
                                <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 800, color: '#475569', marginBottom: '8px', letterSpacing: '0.02em' }}>JADWALKAN TAMPIL (OPSIONAL)</label>
                                <div style={{ display: 'flex', alignItems: 'center', background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '12px 16px', gap: '12px', boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.01) inset', transition: 'all 0.2s' }}>
                                    ...
                                    <input style={{ flex: 1, background: 'transparent', border: 'none', fontWeight: 700, fontSize: '0.9rem', color: '#0f172a', outline: 'none' }} type="datetime-local" name="scheduleDate" />
                                </div>
                                <p style={{ fontSize: '0.65rem', color: '#64748b', fontWeight: 600, marginTop: '6px' }}>*Kosongkan jika ingin langsung tayang saat ini.</p>
                            </div>
                        </div>
                    </div>
