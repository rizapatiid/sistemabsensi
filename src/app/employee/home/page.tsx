    ...
    <div className={styles.pageContainer}>
        <div className={styles.bentoGrid}>
            ...
            <section className={`${styles.bentoBox} ${styles.todayStatusBox}`}>
                ...
                {user && !user.absensiEnabled ? (
                    <div className={styles.statusLiburBox} style={{ background: 'linear-gradient(135deg, #fff5f5, #fee2e2)', border: '1px solid #fca5a5' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '4px', color: '#dc2626' }}>
                            ...
                            <div style={{ fontSize: '0.8rem', fontWeight: 800 }}>AKSES DITANGGUHKAN</div>
                        </div>
                        <Link href="/employee/absensi" className={styles.todayTime} style={{ fontSize: '1rem', marginTop: '8px', color: '#991b1b', textDecoration: 'none', display: 'block' }}>Info lebih lanjut</Link>
                    </div>
                ) : hasAbsenToday ? (
